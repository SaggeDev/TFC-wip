...
export default function Dashboard({ auth, queryParams = null, totalPendingTasks, myPendingTasks, totalProgressTasks, myProgressTasks, totalCompletedTasks, myCompletedTasks, activeTasks,
    ...
    const showedPendingTasks=((auth.user.role=="admin")?totalPendingTasks:myPendingTasks);
    const showedProgressTasks=((auth.user.role=="admin")?totalProgressTasks:myProgressTasks);
    const showedCompletedTasks=((auth.user.role=="admin")?totalCompletedTasks:myCompletedTasks);
                    ...
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900 dark:text-gray-100">
                            ...
                            <p className="text-xl text-center mt-4">
                                <span className="mr-2">{showedPendingTasks}</span>
                            </p>
                        </div>
                    </div>
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900 dark:text-gray-100">
                            ...
                            <p className="text-xl text-center mt-4">
                                <span className="mr-2">{showedProgressTasks}</span>
                            </p>
                        </div>
                    </div>
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900 dark:text-gray-100">
                            ...
                            <p className="text-xl text-center mt-4">
                                <span className="mr-2">{showedCompletedTasks}</span>
                            </p>
                        </div>
                    </div>
                </div>
