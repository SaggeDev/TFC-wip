                                ...
                                <Dropdown>
                                    <Dropdown.Trigger>
                                        <span className="inline-flex rounded-md">
                                            <button
                                                type="button"
                                                className="inline-flex items-center rounded-md bg-gray-100 px-4 py-2 text-sm text-gray-700 hover:bg-gray-200 focus:outline-none transition duration-150 ease-in-out hover:text-gray-700  dark:bg-gray-700 dark:text-gray-200 dark:hover:text-gray-400"
                                            >
                                                {user.name}
